...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "The Voice of Benny Foundation changed my life. Through their programs, I learned valuable skills and connected with like-minded youth who share my vision.",
